...
public class ClassicNovelsActivity extends SherlockFragmentActivity {
    ...
    public boolean onMenuItemSelected(int featureId, MenuItem item) {
	    ...
	    case ID_RESPONSE: // response
    			Toast.makeText(ClassicNovelsActivity.this, "RESPONESE", Toast.LENGTH_SHORT).show();
    		break;
	    case ID_ABOUT_US: // response
			Toast.makeText(ClassicNovelsActivity.this, "ABOUT_US", Toast.LENGTH_SHORT).show();
			break;
	    case ID_GRADE: // response
			Toast.makeText(ClassicNovelsActivity.this, "GRADE", Toast.LENGTH_SHORT).show();
			break;
