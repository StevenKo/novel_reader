...
public class Report {
	...
	private static void showDialog(String novelName, String article, String problem){
    	...
    	Builder a = new AlertDialog.Builder(mActivity).setTitle(mActivity.getResources().getString(R.string.report_title)).setIcon(R.drawable.icon_report)
        .setPositiveButton(mActivity.getResources().getString(R.string.report_confirm), new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
            	if(problemEditText.getText().toString().equals("")){
                  ...
                  emailIntent2.putExtra(android.content.Intent.EXTRA_EMAIL, new String[] { mActivity.getResources().getString(R.string.respond_mail_address) });
                  emailIntent2.putExtra(android.content.Intent.EXTRA_SUBJECT, mActivity.getResources().getString(R.string.report_title));
